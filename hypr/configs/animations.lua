...
hl.animation({ leaf = "workspaces",       enabled = true, speed = 5,  bezier = "smoothWS", style = "slide" })
hl.animation({ leaf = "specialWorkspace", enabled = true, speed = 5,  bezier = "smoothWS", style = "slide" })
