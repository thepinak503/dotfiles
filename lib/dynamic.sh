...
if [[ -x /usr/bin/tput ]] && tput setaf 1 >&/dev/null; then
    export HAS_COLORS=1
    [[ -z "$C_RESET" ]] && export C_RESET='\033[0m'
    [[ -z "$C_BOLD" ]] && export C_BOLD='\033[1m'
    [[ -z "$C_DIM" ]] && export C_DIM='\033[2m'
    [[ -z "$C_UNDERLINE" ]] && export C_UNDERLINE='\033[4m'
    [[ -z "$C_BLINK" ]] && export C_BLINK='\033[5m'
    [[ -z "$C_REVERSE" ]] && export C_REVERSE='\033[7m'
    [[ -z "$C_HIDDEN" ]] && export C_HIDDEN='\033[8m'

    # Standard colors
    [[ -z "$C_BLACK" ]] && export C_BLACK='\033[0;30m'
    [[ -z "$C_RED" ]] && export C_RED='\033[0;31m'
    [[ -z "$C_GREEN" ]] && export C_GREEN='\033[0;32m'
    [[ -z "$C_YELLOW" ]] && export C_YELLOW='\033[0;33m'
    [[ -z "$C_BLUE" ]] && export C_BLUE='\033[0;34m'
    [[ -z "$C_MAGENTA" ]] && export C_MAGENTA='\033[0;35m'
    [[ -z "$C_CYAN" ]] && export C_CYAN='\033[0;36m'
    [[ -z "$C_WHITE" ]] && export C_WHITE='\033[0;37m'

    # Bright colors
    [[ -z "$C_BBLACK" ]] && export C_BBLACK='\033[1;30m'
    [[ -z "$C_BRED" ]] && export C_BRED='\033[1;31m'
    [[ -z "$C_BGREEN" ]] && export C_BGREEN='\033[1;32m'
    [[ -z "$C_BYELLOW" ]] && export C_BYELLOW='\033[1;33m'
    [[ -z "$C_BBLUE" ]] && export C_BBLUE='\033[1;34m'
    [[ -z "$C_BMAGENTA" ]] && export C_BMAGENTA='\033[1;35m'
    [[ -z "$C_BCYAN" ]] && export C_BCYAN='\033[1;36m'
    [[ -z "$C_BWHITE" ]] && export C_BWHITE='\033[1;37m'

    # Background colors
    [[ -z "$C_BG_BLACK" ]] && export C_BG_BLACK='\033[40m'
    [[ -z "$C_BG_RED" ]] && export C_BG_RED='\033[41m'
    [[ -z "$C_BG_GREEN" ]] && export C_BG_GREEN='\033[42m'
    [[ -z "$C_BG_YELLOW" ]] && export C_BG_YELLOW='\033[43m'
    [[ -z "$C_BG_BLUE" ]] && export C_BG_BLUE='\033[44m'
    [[ -z "$C_BG_MAGENTA" ]] && export C_BG_MAGENTA='\033[45m'
    [[ -z "$C_BG_CYAN" ]] && export C_BG_CYAN='\033[46m'
    [[ -z "$C_BG_WHITE" ]] && export C_BG_WHITE='\033[47m'
else
    export HAS_COLORS=0
    [[ -z "$C_RESET" ]] && export C_RESET=''
    export C_BOLD=''
    export C_DIM=''
    export C_UNDERLINE=''
    export C_BLINK=''
