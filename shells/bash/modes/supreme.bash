...
# shellcheck source=/etc/fzf.bash
# =============================================================================
# SUPREME MODE - Full-featured configuration (replaces advanced from Pinak's Dotfiles)
# Includes modern CLI tools, extensive aliases, and developer features
# =============================================================================

# Starship prompt (already configured via .bashrc)
# Zoxide is loaded in core
